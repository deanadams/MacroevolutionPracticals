...
## Installing Packages
In R, there are various packages that include additional functions. These must be installed locally. These are typically installed from CRAN, the primary R repository. Below is an example for several packages we will use this semester: 
